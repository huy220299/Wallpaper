...
import com.example.nvhuy.wallpaper.Activity.SettingsActivity;
import com.example.nvhuy.wallpaper.Ultility.BitmapUtil;
...
//                    drawFrame();
        ...
        private Bitmap getDefaultBitmap() {
            ...
            if (getRotation() == Configuration.ORIENTATION_LANDSCAPE) {
                mBitmap = getFormattedBitmap(R.drawable.user);
